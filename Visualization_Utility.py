...
def plot_decision_tree(clf, feature_names, class_names):
    ...
    export_graphviz(clf, out_file="Tree_Visualization_data.dot", feature_names=feature_names, class_names=class_names, filled = True, impurity = False)
    with open("Tree_Visualization_data.dot") as f:
        dot_graph = f.read()
